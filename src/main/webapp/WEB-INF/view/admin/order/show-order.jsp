                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="/admin/product">
                                    <div
                                        class="icon   border-radius-md  me-2 d-flex align-items-center justify-content-center">
                        ...
                        <div class="container-fluid py-1 px-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                    ...
                                    <li class="breadcrumb-item text-sm text-white active" aria-current="page">Dashboard
                                    </li>
                                </ol>
